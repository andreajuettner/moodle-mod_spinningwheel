...
/**
 * The mod_spinningwheel course module viewed event.
 *
...
/**
 * The course_module_viewed event for the Spinning Wheel activity.
 */
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'spinningwheel';
    }
    ...
    public static function get_objectid_mapping() {
        return ['db' => 'spinningwheel', 'restore' => 'spinningwheel'];
    }
}
